...
-- Step 3 - Add the unique constraint to the Info.Courses table
...
-- Step 1a, 1b and 1c - Add the foreign keys to the Sales.Bookings and Info.Events tables.
...
-- Step 2 - Review the primary / foreign key relationships
...
--Step 1 - Remove all data from the tables and reset identity values
...
--Step 2 - Insert initial Sales.Customers data
...
--Step 3 - Insert initial Info.courses data
...
--Step 7 - Test default constraint
...
--Step 10 - Initial insert of events data
...
--Step 12 - Insert initial sales.bookings data
...
--Step 15 - Test PK-FK constraint (without cascade delete)
...
--Step 16 - Test PK-FK constraint (with cascade delete)
