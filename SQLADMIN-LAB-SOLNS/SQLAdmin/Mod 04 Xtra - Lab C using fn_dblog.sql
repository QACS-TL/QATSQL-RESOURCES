...
SELECT * FROM (
	SELECT  [Transaction ID], [Current LSN], 
			...
			[Log Record]
    FROM fn_dump_dblog (
        NULL, NULL, N'DISK', 1, N'c:\disks\g\Mod04LabC_Tail.bak',
...
RESTORE DATABASE Mod04LabC
	FROM DISK = 'c:\disks\g\Mod04LabC_Initial.bak'
	--FROM DISK = 'H:\Mod04LabC_Initial.bak'
	WITH REPLACE, NORECOVERY
GO

RESTORE DATABASE Mod04LabC
	FROM DISK = 'c:\disks\g\Mod04LabC_Diff.bak'
	--TO DISK = 'H:\Mod04LabC_Diff.bak'
	WITH NORECOVERY
GO

RESTORE LOG Mod04LabC 
	FROM DISK = 'c:\disks\g\Mod04LabC_Tail.bak'
	--FROM DISK = 'H:\Mod04LabC_Tail.bak'
	WITH RECOVERY,STOPBEFOREMARK = 'lsn:0x00000026:00000248:0001'
GO
